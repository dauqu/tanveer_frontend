...
import Images_product from "./Images_product";
import "./Images.css";
import { API } from "./Constant";

function Add_product_container(props) {
  ...
  useEffect(() => {
    fetch(`${API}/api/product`).then((response) =>
              ...
              <ul>
                ...
                <li className="my-3 cursor-pointer add h-[40px] overflow-hidden">
                  ...
                  <ul className="">
                    ...
                    <li className="text-[14px] font-semibold ml-7 leading-[40px] px-3 cursor-pointer bg-[#dceee6] text-[#00a15d] rounded-full h-[40px] add_product_div">
...
export default Add_product_container;
